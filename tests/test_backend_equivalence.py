...
def run_backend(struct, edge, lengths, backend: str, force_grad: bool = True):
    ...
    if backend == "linear_scan":
        ...
        v, potentials = struct.logpartition(edge, lengths=lengths, use_linear_scan=False)
        return v, potentials
        ...
        v, potentials = struct_sharded.logpartition(edge, lengths=lengths, use_linear_scan=False)
        return v, potentials
