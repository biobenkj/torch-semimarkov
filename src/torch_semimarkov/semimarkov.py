...
class SemiMarkov(_Struct):
    ...
    def logpartition(
        ...
        r"""logpartition(log_potentials, lengths=None, force_grad=False, use_linear_scan=None, use_vectorized=False, use_banded=False) -> Tuple[Tensor, List[Tensor], None]
        ...
        Args:
            ...
            use_banded (bool, optional): If ``True``, attempt banded matrix path (prototype).
                Default: ``False``
            banded_perm (str, optional): Permutation mode for banded path. Default: ``"auto"``
            banded_bw_ratio (float, optional): Bandwidth ratio threshold. Default: ``0.6``
        ...
        Examples::
            ...
            >>> log_Z, _, _ = model.logpartition(edge, lengths=lengths, use_vectorized=True)
