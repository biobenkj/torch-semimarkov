...
std::vector<torch::Tensor> banded_cuda_forward(
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "banded_forward_cuda", ([&] {
...
std::vector<torch::Tensor> banded_cuda_backward(
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "matmul_forward_cuda", ([&] {
...
std::vector<torch::Tensor> banded_cuda_backbackward(
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(b.scalar_type(), "matmul_forward_cuda", ([&] {
